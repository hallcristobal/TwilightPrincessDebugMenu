...
pub static STAGES: [(&Stage, &str); 30] = [
    (&DungeonStage::LakebedTemple, "Lakebed Temple"),
    (&DungeonStage::Morpheel, "Morpheel"),
    (&DungeonStage::DekuToad, "Deku Toad"),
    (&DungeonStage::GoronMines, "Goron Mines"),
    (&DungeonStage::Fyrus, "Fyrus"),
    (&DungeonStage::Dangoro, "Dangoro"),
    (&DungeonStage::ForestTemple, "Forest Temple"),
    (&DungeonStage::Diababa, "Diababa"),
    (&DungeonStage::Ook, "Ook"),
    (&DungeonStage::TempleOfTime, "Temple of Time"),
    (&DungeonStage::Armogohma, "Armogohma"),
    (&DungeonStage::Darknut, "Darknut"),
    (&DungeonStage::CityInTheSky, "City in the Sky"),
    (&DungeonStage::Argorok, "Argorok"),
    (&DungeonStage::Aeralfos, "Aeralfos"),
    (&DungeonStage::PalaceOfTwilight, "Palace of Twilight"),
    (&DungeonStage::ZantMainRoom, "Zant Main Room"),
    (&DungeonStage::PhantomZant1, "Phantom Zant 1"),
    (&DungeonStage::PhantomZant2, "Phantom Zant 2"),
    (&DungeonStage::ZantFight, "Zant Fight"),
    (&DungeonStage::HyruleCastle, "Hyrule Castle"),
    (&DungeonStage::GanondorfCastle, "Ganondorf Castle"),
    (&DungeonStage::GanondorfField, "Ganondorf Field"),
    (&DungeonStage::GanondorfDefeated, "Ganondorf Defeated"),
    (&DungeonStage::ArbitersGrounds, "Arbiters Grounds"),
    (&DungeonStage::Stallord, "Stallord"),
    (&DungeonStage::DeathSword, "Death Sword"),
    (&DungeonStage::SnowpeakRuins, "Snowpeak Ruins"),
    (&DungeonStage::Blizzeta, "Blizzeta"),
    (&DungeonStage::Darkhammer, "Darkhammer"),
];
